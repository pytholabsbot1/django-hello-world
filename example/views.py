...
def index(request):
    ...
    return render(request, "example/comp/home.html", context=context)
...
def property(request, project):
    ...
    return render(request, "example/property.html", context=context)
...
def PropTest(request):
    ...
    return render(request, "example/property1.html", context=context)
...
def tour(request):
    ...
    return render(request, "example/comp/tour1.html", context=context)
...
def dash(request):
    ...
    return render(request, "example/analysis/dash.html", context=context)
